...
from higgs_dna.selections.photon_preselections_BBGG import photon_preselections_BBGG
...
class HtoBBGG_bkg(HggBaseProcessor):
    ...
    def process(self, events: awkward.Array) -> Dict[Any, Any]:
        ...
        for variation in variations:
            ...
            # photon preselection
            photons, b_jets, leps = photon_preselections_BBGG(self, photons, events, year=self.year[dataset_name][0])
